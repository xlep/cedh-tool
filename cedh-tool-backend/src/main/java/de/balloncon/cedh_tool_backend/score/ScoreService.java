...
//  public static final String DIVIDER_FOR_DRAW = "4.000";
  ...
  public List<TournamentPlayer> calculatePlayerScoresAfterSwissRounds(UUID tournamentId,
    ...
    List<TournamentPlayer> tournamentPlayers =
        tournamentPlayerService.findByTournament(tournamentId);
...
//        log("No score found for player " + playerId);
...
//    List<TournamentPlayer> tournamentPlayers =
//        tournamentPlayerService.findByTournamentAndPlayers(tournamentId, playerIds);
//
