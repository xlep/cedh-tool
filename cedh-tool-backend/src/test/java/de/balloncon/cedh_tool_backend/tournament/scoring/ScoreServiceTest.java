package de.balloncon.cedh_tool_backend.tournament.scoring;
...
private static Pod pod;
  ...
  void testFullTournament() {
    ...
    List<TournamentPlayer> tournamentPlayers = scoreService.calculatePlayerScoresAfterSwissRounds(
        tournamentId, 5);
  ...
  void TestRoundPermutations() {
    ...
    List<List<Integer>> permutations = scoreService.generatePermutations(rounds);
