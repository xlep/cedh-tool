...
function PlayerManager() {
  ...
  return (
    <div style={{ padding: '0 10px' }}>
      ...
      {!loading && !error && players.length > 0 && (
        <>
          <div className="total-players" style={{ fontWeight: 'bold', color: '#ff7f11', marginBottom: '0.5rem', textAlign: 'right' }}>
                ...
                return (
                  <tr key={playerId}>
                      ...
                      {isEditing ? (
                        <>
                          ...
                          <div style={{ marginTop: '4px' }}>
                            <button onClick={() => saveDecklist(playerId)}>Save</button>
                            <button onClick={() => cancelEditing(playerId)} style={{ marginLeft: '4px' }}>
                              Cancel
                            </button>
                          </div>
                        </>
                    ...
                    <td>
                      ...
                      <button onClick={() => startEditingDecklist(playerId)} style={{ marginLeft: '8px' }}>
                        Modify Decklist
                      </button>
                      <button
